...
STRINGS.NAMES.SENDI_FOOD_COCOA_COLD = "차가운 코코아" 
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_COCOA_COLD = "얼음처럼 차가운 코코아. \n 정신이 번쩍들어"
...
--AlieKat, Write it down to fit the character!
...
STRINGS.CHARACTERS.GENERIC.ONEATSENDIFOOD = { -- "Wilson" and "mode character" without lines
TEST = "맛있다.",
