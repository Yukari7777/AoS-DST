...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_COCOAPOWDER = "이 가루는 요리에 넣으면, 어울리는 맛으로 변화해요!"
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_MARATANG_BAT = "일단은.. 담았어요.\n 생고기니까, 날로먹으면 큰일나요!"
STRINGS.NAMES.SENDI_FOOD_MARATANG_BAT_COOKED = "엽기적인 마라탕" 
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_MARATANG_BAT_COOKED = "..이 요리는 실패했어요. 외형적으로도, 맛으로도...\n..심리적으로 끌리지 않네요!"

STRINGS.NAMES.SENDI_FOOD_MARATANG_FROG = "개구리 접시" 
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_MARATANG_FROG = "일단은.. 담았어요.\n 생고기니까, 날로먹으면 큰일나요!"
STRINGS.NAMES.SENDI_FOOD_MARATANG_FROG_COOKED = "개굴개굴 마라탕" 
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SENDI_FOOD_MARATANG_FROG_COOKED = "이 요리는 실패했어요. 외형적으로도, 맛으로도...\n 네? 맛있다구요? 정말루..?"
