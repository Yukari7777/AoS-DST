TUNING.AOS_GENERAL = {
    ...
    BUFF_STEALTH_DURATION = 10,

    BUFF_SPEEDUP_MAXTIME = 15, -- 이속증가 최대시간
    BUFF_SPEEDUP_MULTIPLIER = 1.15, --이속 증가량(워킹케인 : 1.25)
...
TUNING.ANAN = {--아난
    ...
    SKILL_SNOWWIND_TOTAL_SPEEDBOOST_TIME = 10, 

    SKILL_ANANSTEALTH_MANACOST = 50,
}
...
TUNING.TEES = {--티스
    ...
    SKILL_VENOMSPREAD_SPREAD_CHANCE = 1, -- 독이 주변으로 퍼질 확률
